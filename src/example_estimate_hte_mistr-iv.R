...
test_df$TOTAL_VAR_MISTRIV <- test_df$MEAN_VAR_HTE + (1 + 1 / n_htes) * test_df$IMPUTATION_VAR_HTE

write.csv(test_df, paste0(base_dir, "output/", datatype, "/n_", n_patients, "_seed_", seed, "_test_with_htes_iv.csv"))
